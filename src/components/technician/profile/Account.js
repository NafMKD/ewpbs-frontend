...
class Account extends Component {
  ...
  submitFormData = (e) => {
    ...
    if (Object.keys(fields).length !== 0) {
      ...
      const api =
        "http://127.0.0.1:8000/api/spemployee/spemployee_account/" +
        this.state.account_user.sp_emp_id;
      axios
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-8">
                  ...
                  <span className="text-danger">
                    {this.state.errors["sp_emp_username"]}
                  </span>
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-8">
                  <input
                    ...
                    name="old_sp_emp_password"
                    onChange={(e) => {
                      this.inputChangeHandler(e);
                    }}
                  />
                  <span className="text-danger">
                    {this.state.errors["old_sp_emp_password"]}
                  </span>
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-8">
                  ...
                  />
                  <span className="text-danger">
                    {this.state.errors["sp_emp_password"]}
                  </span>
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-8">
                  ...
                  />
                  <span className="text-danger">
                    {this.state.errors["sp_emp_password_confirmation"]}
                  </span>
                </div>
              </div>
              <button
