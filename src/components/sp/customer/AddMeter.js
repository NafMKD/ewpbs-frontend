...
class Addmeter extends Component {
  ...
  render() {
    if (Object.keys(this.state.customer).length) Swal.close();
    return (
          ...
          <div className="container-fluid">
            <div className="card card-outline card-primary">
              <div className="card-header">
                <h3 className="card-title">Add Meter: (<em>Locations are in Decimal Degrees format</em>)</h3>
                <div className="card-tools mr-5">
                  <button className="btn btn-tool" onClick={(e)=>{this.getLocation()}}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-5">
                        <div className="form-group">
                          ...
                          <input
                            type="text"
                            className={this.state.errors['meter_longitude']?"form-control  is-invalid":"form-control"}
                            value={this.state.fields['meter_longitude']?this.state.fields['meter_longitude']:""}
                            placeholder="Enter Longitude"
                            name="meter_longitude"
                            onChange = {(e)=>{this.inputHandler(e)}}
                          />
                          <span className="text-danger">{this.state.errors['meter_longitude']}</span>
                        </div>
                        <div className="form-group">
                          <label>Meter Serial Number:</label>
                          <input
                            type="text"
                            className={this.state.errors['meter_serial']?"form-control  is-invalid":"form-control"}
                            value={this.state.fields['meter_serial']?this.state.fields['meter_serial']:""}
                            placeholder="Enter Serial Number"
                            name="meter_serial"
                            onChange = {(e)=>{this.inputHandler(e)}}
                          />
                          <span className="text-danger">{this.state.errors['meter_serial']}</span>
                        </div>
                      </div>
                      ...
                      <div className="col-md-5">
                        <div className="form-group">
                          ...
                          <input
                            type="text"
                            className={this.state.errors['meter_latitude']?"form-control  is-invalid":"form-control"}
                            value={this.state.fields['meter_latitude']?this.state.fields['meter_latitude']:""}
                            placeholder="Enter Latitude"
                            name="meter_latitude"
                            onChange = {(e)=>{this.inputHandler(e)}}
                          />
                          <span className="text-danger">{this.state.errors['meter_latitude']}</span>
                        </div>
                      </div>
                    </div>
                  </div>
