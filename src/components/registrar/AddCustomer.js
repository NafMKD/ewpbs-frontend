...
class Addcustomer extends Component {
    ...
    validateStateInput = () =>{
        ...
        }else if (typeof fields["customer_password_confirmation"] !== "undefined") {
            if (fields["customer_password_confirmation"] !== fields["customer_password"]) {
                formIsValid = false;
    ...
    submitForm = (e) =>{
        ...
        if(this.validateStateInput()){
            ...
            axios.post(api, {
                ...
                'customer_password_confirmation' : this.state.fields['customer_password_confirmation']
            ...
            <div className="card-body">
              ...
              <form onSubmit={(e)=>{this.submitForm(e)}}>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_first_name']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter First Name"
                    value={this.state.fields['customer_first_name']?this.state.fields['customer_first_name']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_first_name"
                  />
                  <span className="text-danger">{this.state.errors['customer_first_name']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_middle_name']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter Middle Name"
                    value={this.state.fields['customer_middle_name']?this.state.fields['customer_middle_name']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_middle_name"
                  />
                  <span className="text-danger">{this.state.errors['customer_middle_name']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_last_name']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter Last Name"
                    value={this.state.fields['customer_last_name']?this.state.fields['customer_last_name']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_last_name"
                  />
                  <span className="text-danger">{this.state.errors['customer_last_name']}</span>
                </div>
                <div className="form-group">
                  <Select options={regionOptions} styles={customStyles} onChange={(e)=>{this.inputHandler(e)}}/>
                  <span className="text-danger">{this.state.errors['customer_region']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_phone']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter Phone"
                    value={this.state.fields['customer_phone']?this.state.fields['customer_phone']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_phone"
                  />
                  <span className="text-danger">{this.state.errors['customer_phone']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_town']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter Town"
                    value={this.state.fields['customer_town']?this.state.fields['customer_town']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_town"
                  />
                  <span className="text-danger">{this.state.errors['customer_town']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_kebele']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter Kebel"
                    value={this.state.fields['customer_kebele']?this.state.fields['customer_kebele']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_kebele"
                  />
                  <span className="text-danger">{this.state.errors['customer_kebele']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_house_no']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter House No."
                    value={this.state.fields['customer_house_no']?this.state.fields['customer_house_no']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_house_no"
                  />
                  <span className="text-danger">{this.state.errors['customer_house_no']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="text"
                    className={this.state.errors['customer_username']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter username"
                    value={this.state.fields['customer_username']?this.state.fields['customer_username']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_username"
                  />
                  <span className="text-danger">{this.state.errors['customer_username']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="password"
                    className={this.state.errors['customer_password']?"form-control  is-invalid":"form-control"}
                    placeholder="Enter password"
                    value={this.state.fields['customer_password']?this.state.fields['customer_password']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_password"
                  />
                  <span className="text-danger">{this.state.errors['customer_password']}</span>
                </div>
                <div className="form-group">
                  <input
                    type="password"
                    className={this.state.errors['customer_password_confirmation']?"form-control  is-invalid":"form-control"}
                    placeholder="Confirm password"
                    value={this.state.fields['customer_password_confirmation']?this.state.fields['customer_password_confirmation']:""}
                    onChange={(e)=>{this.inputHandler(e)}}
                    name="customer_password_confirmation"
                  />
                  <span className="text-danger">{this.state.errors['customer_password_confirmation']}</span>
                </div>
                <div className="row">
